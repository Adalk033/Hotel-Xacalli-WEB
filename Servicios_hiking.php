...
<body>
    ...
    $link=Conectarse();
     //Servicio 4
     $costo4 = mysqli_query($link, "Select costo from web_servicios where id_svo = '4'");
     $row_costo4 = mysqli_fetch_row($costo4);

     $duracion4 = mysqli_query($link, "Select duracion from web_servicios where id_svo = '4'");
     $row_duracion4 = mysqli_fetch_row($duracion4);

     $descripcion4 = mysqli_query($link, "Select descripcion from web_servicios where id_svo = '4'");
     $row_descripcion4 = mysqli_fetch_row($descripcion4);

     $result = mysqli_query($link, "SELECT imagen FROM web_servicios WHERE id_svo = '4'");
    ...
    <div class="information-dad">
        ...
        <div class="hijo">
            ...
            <p>La duracion es: <?php
                    echo "$row_duracion4[0]";
                ?></p>
            <p>Acerca de: <?php
                    echo "$row_descripcion4[0]";
                ?></p>
        </div>
    </div>
  <br>
