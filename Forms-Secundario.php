...
<body>
    <script src="Scripts/Vaidacion-Forms-Secundario.js"></script>
    <br><br>
    <section class="Formulario">
        ...
        ?>
        <table align="center">
            <form name="formulario" action="Info2.php" method="POST">
                <tr>
                    <td>
                        Fecha a reservar: 
                    </td>
                ...
                <tr>
                    <td colspan>
                        <input type= "button" name="Enviar" onclick="valida_envia()" value="Enviar"> 
                    </td>
