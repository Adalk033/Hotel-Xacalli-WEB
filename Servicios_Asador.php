...
<body>
    ...
    <?php
        include "conect.php";
        $link=Conectarse();
        $costo2 = mysqli_query($link, "Select costo from web_servicios where id_svo = '2'");
        $row_costo2 = mysqli_fetch_row($costo2);

        $duracion2 = mysqli_query($link, "Select duracion from web_servicios where id_svo = '2'");
        $row_duracion2 = mysqli_fetch_row($duracion2);

        $descripcion2 = mysqli_query($link, "Select descripcion from web_servicios where id_svo = '2'");
        $row_descripcion2 = mysqli_fetch_row($descripcion2);

        $result = mysqli_query($link, "SELECT imagen FROM web_servicios WHERE id_svo = '2'");
    ...
    <div class="information-dad">
        <!-- Slideshow container -->
        <!--<img src="Imagenes/SV1.jpg" id="imagenP" alt="">-->
        <?php
        ...
        <div class="hijo">
            ...
            <p>La duracion es: <?php
                    echo "$row_duracion2[0]";
                ?></p>
            <p> Acerca de:<?php
                    echo "$row_descripcion2[0]";
                ?></p>
        </div>
    </div>
  <br>
