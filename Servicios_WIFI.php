...
<body>
    ...
    <?php
        ...
        $link=Conectarse();
         //Servicio 7
        $costo7 = mysqli_query($link, "Select costo from web_servicios where id_svo = '7'");
        $row_costo7 = mysqli_fetch_row($costo7);

        $duracion7 = mysqli_query($link, "Select duracion from web_servicios where id_svo = '7'");
        $row_duracion7 = mysqli_fetch_row($duracion7);

        $descripcion7 = mysqli_query($link, "Select descripcion from web_servicios where id_svo = '7'");
        $row_descripcion7 = mysqli_fetch_row($descripcion7);

        $result = mysqli_query($link, "SELECT imagen FROM web_servicios WHERE id_svo = '7'");
    ...
    <div class="information-dad">
        ...
        <div class="hijo">
            ...
            <p>La duracion es: <?php
                    echo "$row_duracion7[0]";
                ?></p>
            <p> Acerca de: <?php
                    echo "$row_descripcion7[0]";
                ?></p>
        </div>
    </div>
  <br>
