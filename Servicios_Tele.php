...
<body>
    ...
    $link=Conectarse();
     //Servicio 6
     $costo6 = mysqli_query($link, "Select costo from web_servicios where id_svo = '6'");
     $row_costo6 = mysqli_fetch_row($costo6);

     $duracion6 = mysqli_query($link, "Select duracion from web_servicios where id_svo = '6'");
     $row_duracion6 = mysqli_fetch_row($duracion6);

     $descripcion6 = mysqli_query($link, "Select descripcion from web_servicios where id_svo = '6'");
     $row_descripcion6 = mysqli_fetch_row($descripcion6);

     $result = mysqli_query($link, "SELECT imagen FROM web_servicios WHERE id_svo = '6'");
    ...
    <div class="information-dad">
        <!-- Slideshow container -->
        <!--<img src="Imagenes/SV5.jpg" id="imagenP" alt="">-->
        <?php
        ...
        <div class="hijo">
            ...
            <p>La duracion es: <?php
                    echo "$row_duracion6[0]";
                ?></p>
            <p>Acerca de: <?php
                    echo "$row_descripcion6[0]";
                ?></p>
        </div>
    </div>
  <br>
