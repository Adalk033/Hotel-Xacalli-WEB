...
<body>
    ...
    <?php
        ...
        //Servicio 3
        $costo3 = mysqli_query($link, "Select costo from web_servicios where id_svo = '3'");
        $row_costo3 = mysqli_fetch_row($costo3);

        $duracion3 = mysqli_query($link, "Select duracion from web_servicios where id_svo = '3'");
        $row_duracion3 = mysqli_fetch_row($duracion3);

        $descripcion3 = mysqli_query($link, "Select descripcion from web_servicios where id_svo = '3'");
        $row_descripcion3 = mysqli_fetch_row($descripcion3);

        $result = mysqli_query($link, "SELECT imagen FROM web_servicios WHERE id_svo = '3'");
    ...
    <div class="information-dad">
        ...
        <div class="hijo">
            ...
            <p>La duracion es: <?php
                    echo "$row_duracion3[0]";
                ?></p>
            <p>Acerca de: <?php
                    echo "$row_descripcion3[0]";
                ?></p>
        </div>
    </div>
  <br>
