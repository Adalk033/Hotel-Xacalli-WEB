...
<body>
    ...
    <?php
        ...
        //Servicio 1
        $costo1 = mysqli_query($link, "Select costo from web_servicios where id_svo = '1'");
        $row_costo1 = mysqli_fetch_row($costo1);

        $duracion1 = mysqli_query($link, "Select duracion from web_servicios where id_svo = '1'");
        $row_duracion1 = mysqli_fetch_row($duracion1);

        $descripcion1 = mysqli_query($link, "Select descripcion from web_servicios where id_svo = '1'");
        $row_descripcion1 = mysqli_fetch_row($descripcion1);

        $result = mysqli_query($link, "SELECT imagen FROM web_servicios WHERE id_svo = '1'");
    ...
    <div class="information-dad">
        <!-- Slideshow container -->
        <!--<img src="Imagenes/SV3.jpg" id="imagenP" alt="">-->
        <?php
        ...
        <div class="hijo">
            ...
            <p>La duracion es: <?php
                    echo "$row_duracion1[0]";
                ?></p>
            <p>Acerca de: <?php
                    echo "$row_descripcion1[0]";
                ?></p>
        </div>
    </div>
  <br>
